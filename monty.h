...
#define PUSH_FAIL "L%d: usage: push integer\n"
#define PINT_FAIL "L%d: can't pint, stack empty\n"
#define POP_FAIL "L%d: can't pop an empty stack\n"
#define SWAP_FAIL "L%d: can't swap, stack too short\n"
#define ADD_FAIL "L%d: can't add, stack too short\n"
#define SUB_FAIL "L%d: can't sub, stack too short\n"
#define DIV_FAIL "L%d: can't div, stack too short\n"
#define DIV_ZERO "L%d: division by zero\n"
#define MUL_FAIL "L%d: can't mul, stack too short\n"
#define MOD_FAIL "L%d: can't mod, stack too short\n"
#define PCHAR_FAIL "L%d: can't pchar, stack empty\n"
#define PCHAR_RANGE "L%d: can't pchar, value out of range\n"
